...
public class VelocityScriptEngine extends AbstractComponent implements ScriptEngine {
	 ...
	 * 
	 * public void eval(Map<String, Object> ctx, String templateName, OutputStream out) throws Exception { OutputStreamWriter writer = new OutputStreamWriter(out); engine.mergeTemplate(scriptPath + templateName, new ScriptContext(ctx), writer); }
	 * 
	 * public boolean evalRule(Map<String, Object> context, String templateName) throws Exception { throw new NotYetImplemented(); }
	 * 
	 * public boolean evalRuleScript(Map<String, Object> context, String rule) throws Exception { throw new NotYetImplemented(); }
	 * 
	 * public String evalScript(Map<String, Object> ctx, String script) throws Exception { StringWriter writer = new StringWriter(); Velocity.evaluate(new ScriptContext(ctx), writer, SCRIPT_LOG_TAG, script); return writer.toString(); }
	 * 
	 * public void evalScript(Map<String, Object> ctx, String script, OutputStream out) throws Exception { OutputStreamWriter writer = new OutputStreamWriter(out); Velocity.evaluate(new ScriptContext(ctx), writer, SCRIPT_LOG_TAG, script); }
	 * 
	 ...
	 * 
	 * public class ScriptContext extends VelocityContext { public ScriptContext(Map<String, Object> ctx) { super(ctx); } }
	 * 
